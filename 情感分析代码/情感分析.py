...
if __name__ == '__main__':
    sentiment_dict_path = "C:\\Users\\ASUS\\Desktop\\毕论\\情感分析\\情感词典\\sentiment_words_chinese.tsv" 
    degree_dict_path = "C:\\Users\\ASUS\\Desktop\\毕论\\情感分析\\情感词典\\degree_dict.txt"
    stop_dict_path = "C:\\Users\\ASUS\\Desktop\\毕论\\情感分析\\stop_words.txt"

    #文件读取
    f = open('C:\\Users\\ASUS\\Desktop\\毕论\\情感分析\\原文件及分析结果\\《国家宝藏》第二季第一期-弹幕_Sheet1.csv',encoding='utf8')
    data = pd.read_csv(f)

    #文件写入
    c = open("C:\\Users\\ASUS\\Desktop\\毕论\\情感分析\\原文件及分析结果\\《国家宝藏》第二季第一期-弹幕情感分析结果.csv", "a+", newline='', encoding='utf8')
    writer = csv.writer(c)
